<template>
  ...
  <Admin>
                    ...
                    <tr v-for="rit in rits" :key="rit.id">
                      ...
                      >
                        <div class="flex flex-col gap-y-2">
                          <div class="font-medium text-gray-900">
                            Customer:
                            {{ formatNumber(rit.customer_tonnage) }} kg
                          </div>
                          <div class="font-medium text-gray-900">
    ...
    <div
      v-else
      class="max-w-7xl mx-auto px-4 py-8 text-center text-red-500 font-bold"
    >
