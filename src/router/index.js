...
import FinanceLabaRugi from "/src/views/admin/finance/laba_rugi.vue";
...
const routes = [
  ...
  {
    path: "/admin/finance/laba_rugi",
    name: "FinanceLabaRugi",
    component: FinanceLabaRugi,
    meta: {
      title: "Finance - Laba Rugi",
    },
  },
  {
